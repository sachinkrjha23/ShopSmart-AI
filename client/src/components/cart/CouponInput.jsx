  ...
  return (
    <form onSubmit={handleApply} className="flex gap-2 mb-3">
      <input
        ...
        disabled={loading}
        className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 uppercase placeholder:normal-case"
      />
      <button
        type="submit"
        disabled={loading}
