...
const HeroBanner = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-teal-600 via-teal-700 to-purple-800 min-h-[70vh] flex items-center">
      {/* Decorative blobs */}
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
        <div className="max-w-3xl mx-auto lg:mx-0 text-center lg:text-left">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-sm font-medium text-teal-100">AI-Powered Shopping</span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            Shop smarter with your{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-200 to-purple-200">
              personal AI assistant
            </span>
          </h1>

          {/* Description */}
          <p className="text-lg sm:text-xl text-teal-100 leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <Link
              to="/products"
              className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 bg-white text-teal-700 font-semibold rounded-xl shadow-lg hover:shadow-xl hover:bg-teal-50 transition-all duration-200 text-base"
            >
              Shop Now
