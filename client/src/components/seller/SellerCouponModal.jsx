...
import { addSellerCoupon, editSellerCoupon } from '../../store/slices/sellerSlice'
...
const SellerCouponModal = ({ isOpen, onClose, coupon, onSaved }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await dispatch(editSellerCoupon({ id: coupon.id, data: payload })).unwrap()
        toast.success('Coupon updated successfully!')
      } else {
        await dispatch(addSellerCoupon(payload)).unwrap()
...
export default SellerCouponModal