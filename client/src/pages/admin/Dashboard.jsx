...
const Dashboard = () => {
  ...
  const orderStatusEntries = Object.entries(stats.orderStatusCounts || {});
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatsCard label="Total Customers" value={stats.totalUsersCount} />
        <StatsCard label="New Customers This Month" value={stats.newUsersThisMonth} />
      </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              <OrderStatusPieChart counts={stats.orderStatusCounts} />
